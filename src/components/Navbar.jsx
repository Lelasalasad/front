      ...
      <ul className={`nav-links${menuOpen ? " active" : ""}`}>
        {user ? (
          <>
            ...
            {isAdmin && (
              <li>
                <Link to="/AdminAccountMovements">
                  <FaUserShield /> {t("AdminAccountMovements")}
                </Link>
              </li>
            )}
            <li>
              <Link to="/UserAccountMovements">
                <FaHistory /> {t("UserAccountMovements")}
              </Link>
            </li>
            <li>
              <Link to="/transactions">
                <FaMoneyBillWave /> {t("Transactions")}
              </Link>
            </li>
            <li>
              <Link to="/profile">
